...
/** \mainpage RoboComp::RGBD2PCD
 *
 * \section intro_sec Introduction
 *
 * The RGBD2PCD component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/RGBD2PCD --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class RGBD2PCD : public RoboComp::Application
{
public:
	RGBD2PCD (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::RGBD2PCD::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
