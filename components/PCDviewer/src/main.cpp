...
/** \mainpage RoboComp::pcdViewer
 *
 * \section intro_sec Introduction
 *
 * The pcdViewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/pcdViewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class pcdViewer : public RoboComp::Application {
public:
    pcdViewer(QString prfx) { prefix = prfx.toStdString(); }
...
void pcdViewer::initialize() {
    // Config file properties read example
    // configGetString( PROPERTY_NAME_1, property1_holder, PROPERTY_1_DEFAULT_VALUE );
    // configGetInt( PROPERTY_NAME_2, property1_holder, PROPERTY_2_DEFAULT_VALUE );
}

int pcdViewer::run(int argc, char *argv[]) {
#ifdef USE_QTGUI
    ...
    try {
        ...
        Ice::ObjectAdapterPtr adapterCommonBehavior = communicator()->createObjectAdapterWithEndpoints("commonbehavior",
                                                                                                       tmp);
