...
protected:
    ...
    bool configGetString(const std::string prefix, const std::string name, std::string &value,
                         const std::string default_value, QStringList *list = NULL);

public:
    static bool configGetString(Ice::CommunicatorPtr communicator, const std::string prefix, const std::string name,
                                std::string &value, const std::string default_value, QStringList *list = NULL);
